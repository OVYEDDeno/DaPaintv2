...
export const DaPaintCreate = ({ showDaPaintCreate, toggleDaPaintCreate, onCreateSuccess }) => {
  ...
  if (!showDaPaintCreate) return null;
    ...
    <div className="auth-overlay">
      <div className="auth-modal">
        <div className="auth-header">
          ...
          <button className="close-btn" onClick={toggleDaPaintCreate}>×</button>
        </div>
